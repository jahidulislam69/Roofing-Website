  ...
  return (
    ...
    <div className="w-screen min-h-screen mt-10 relative z-1">
        ...
        <div className="container mx-auto ">
            ...
            <div className="flex md:flex-row flex-col z-11 justify-center items-center mb-20 gap-10 absolute inset-0 md:top-220 top-240">
            <SmallCart/>
            <SmallCart/>
            </div>
    ...
    <div className="mt-20 container mx-auto text-center md:p-30 p-40">
